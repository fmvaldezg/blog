...
El caso de Galápagos es muy particular puesto que, al tratarse de una isla con muchas regulaciones en materia de residencia y de turismo, la existencia de rentas de corta estancia si podría funcionar como una oportunidad para complementar los ingresos de los habitantes locales. Al mismo tiempo, la regulación de la actividad puede terminar beneficiando a unos pocos, especialmente a los anunciantes comerciales. Es importante considerar que Galápagos ya cuenta con regulaciónes que buscan controlar el número de turistas, sin embargo, cada año se incrementa este número. Por otro lado, la no regulación de las actividades no disminuirá las inequidades existentes en el archipielago, como algunos 'hosts' quieren hacerlo parecer. 
